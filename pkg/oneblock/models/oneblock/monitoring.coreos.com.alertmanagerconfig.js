...
export default class HciAlertmanagerConfig extends SteveModel {
  get _detailLocation() {
    return {
      ...
      params: {
        ...
        resource:  OB.ALERTMANAGERCONFIG,
  ...
  get doneOverride() {
    ...
    detailLocation.params.resource = OB.ALERTMANAGERCONFIG;
  ...
  get parentNameOverride() {
    return this.$rootGetters['i18n/t'](`typeLabel."${ OB.ALERTMANAGERCONFIG }"`, { count: 1 })?.trim();
  }
