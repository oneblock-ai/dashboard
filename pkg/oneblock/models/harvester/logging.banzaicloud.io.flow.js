...
export default class HarvesterLogFlow extends Flow {
  get allOutputs() {
    return this.$rootGetters['oneblock/all'](LOGGING.OUTPUT) || [];
  }

  get allClusterOutputs() {
    return this.$rootGetters['oneblock/all'](LOGGING.CLUSTER_OUTPUT) || [];
  }
  ...
  get detailLocation() {
    ...
    detailLocation.params.resource = OB.FLOW;
  ...
  get parentNameOverride() {
    return this.$rootGetters['i18n/t'](`typeLabel."${ OB.FLOW }"`, { count: 1 })?.trim();
  }
